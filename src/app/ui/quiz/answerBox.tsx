...
import { playConfetti } from "@/app/lib/playConfetti";
import {
  faXmarkSquare,
  faCheckSquare,
...
export default function AnswerBox({
  ...
  // `solved` has higher priority than `selected`
  return (
    <div
      onClick={checkAnswer}
      className={clsx([
        ...
        { "border-titleForeground bg-button": !selected && !solved },
        {
    ...
    >
      ...
      <FontAwesomeIcon
        ...
        className={clsx(
          selected || solved ? "scale-100" : "scale-0",
          "mx-4 ml-auto",
        )}
      ></FontAwesomeIcon>
    </div>
